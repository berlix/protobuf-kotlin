...
class BasicsIntegrationTest : StringSpec({
    ...
    with (IntegrationTestUtil()) {
        ...
        "creates message for empty class" {
            givenSchema(
        ...
        "creates multiple root messages" {
            givenSchema(
                listOf(
                    EmptyClass.serializer().descriptor,
                    Object.serializer().descriptor
        ...
        "creates message with custom field numbers" {
            givenSchema(
            ...
            verifyConversion(
                ClassWithCustomFieldNumbers(17, "strong", true, 99L),
                """5: 17 1: {"strong"} 8: true 2: 99"""
            )
        }

        "creates message with scalar properties" {
        ...
        "creates message with unsigned ints" {
        ...
        "creates message referring to other message" {
        ...
        "creates messages referring to same other message" {
            givenSchema(
                listOf(
        ...
        "creates self-referential message" {
            givenSchema(
        ...
        "creates messages with cyclical references" {
            givenSchema(
        ...
        "creates class with custom serial name" {
            givenSchema(
        ...
        "creates class with property with custom serial name" {
            givenSchema(
        ...
        "creates class with property with custom serializer" {
            givenSchema(
        ...
        "creates class with custom serializer that encodes bytes" {
            givenSchema(
        ...
        "does not create synthetic top-level message for nullable ByteArray" {
    ...
    data class Scalars(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            if (other !is Scalars) return false
