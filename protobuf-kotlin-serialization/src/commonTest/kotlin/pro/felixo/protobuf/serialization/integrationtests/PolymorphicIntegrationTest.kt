...
class PolymorphicIntegrationTest : StringSpec({
    ...
    with (IntegrationTestUtil()) {
        "creates messages for sealed class hierarchy" {
            givenSchema(
        ...
        "creates messages for non-sealed polymorphic class hierarchy" {
            givenSchema(
        ...
        "creates messages for sealed class hierarchy with diverse sub-types" {
            givenSchema(
