...
class MapIntegrationTest : StringSpec({
    isolationMode = IsolationMode.InstancePerTest
    with (IntegrationTestUtil()) {
        "creates message for class with map of scalars" {
            givenSchema(
        ...
        "creates message for class with nullable map" {
            givenSchema(
        ...
        "creates message for class with nested maps" {
            givenSchema(
        ...
        "creates message for class with map with custom entry property names" {
            givenSchema(
        ...
        "creates message for class with map of references" {
            givenSchema(
        ...
        "does not create schema with synthetic top-level message for map" {
