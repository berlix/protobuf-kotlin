...
class ListIntegrationTest : StringSpec({
    ...
    with (IntegrationTestUtil()) {
        "creates message for class with list of int" {
            givenSchema(
        ...
        "creates message for class with list of UInt" {
            givenSchema(
        ...
        "creates message for class with list of float" {
            givenSchema(
        ...
        "creates message for class with list of double" {
            givenSchema(
        ...
        "creates message for class with list of string" {
            givenSchema(
        ...
        "creates message for class with list of bytes" {
            givenSchema(
        ...
        "creates message for class with list of enum" {
            givenSchema(
        ...
        "creates message for class with list of empty class" {
            givenSchema(
        ...
        "creates message for class with list of simple class" {
            givenSchema(
        ...
        "creates message for class with list of sealed class" {
            givenSchema(
        ...
        "creates message for class with nullable list" {
            givenSchema(
        ...
        "creates message for class with list of nullable scalar" {
            givenSchema(
        ...
        "creates message for class with list of nullable bytes" {
            givenSchema(
        ...
        "creates message for class with list of nullable message" {
            givenSchema(
        ...
        "creates message for class with list of scalar with custom settings" {
            givenSchema(
        ...
        "creates message for class with list of nullable scalar with custom settings" {
            givenSchema(
            ...
            verifyConversion(
                ClassWithListOfNullableScalarWithCustomSettings(listOf(5, 6)),
                "1: { 5: 5i32 } 1: { 5: 6i32 }"
            )
            verifyConversion(
                ClassWithListOfNullableScalarWithCustomSettings(listOf(null, 7, null)),
                "1: {} 1: { 5: 7i32 } 1: {}"
            )
        ...
        "does not create schema with synthetic top-level message for list" {
    ...
    data class ClassWithListOfBytes(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            if (other !is ClassWithListOfBytes) return false
    ...
    data class ClassWithListOfNullableBytes(
        ...
        override fun equals(other: Any?): Boolean {
            if (this === other) return true
            if (other !is ClassWithListOfNullableBytes) return false
