...
class SchemaReader(private val tokenizer: SchemaTokenizer = SchemaTokenizer()) {
    ...
    private fun readMessage(tokens: Iterator<Token>): Message {
        ...
        val types = mutableSetOf<Type>()
        val reservedNames = mutableSetOf<Identifier>()
        val reservedNumbers = mutableSetOf<IntRange>()
        while (true) {
            when (val token = tokens.expectToken()) {
    ...
    private fun readEnum(tokens: Iterator<Token>): Enumeration {
        ...
        val values = mutableSetOf<EnumValue>()
        val reservedNames = mutableSetOf<Identifier>()
        val reservedNumbers = mutableSetOf<IntRange>()
    ...
    private fun MutableSet<EnumValue>.putEnumValue(name: Token.Identifier, tokens: Iterator<Token>) {
        tokens.expect<Token.Equals>()
    ...
    private fun MutableSet<Member>.putMember(firstToken: Token.Identifier, tokens: Iterator<Token>) {
        when (firstToken) {
    ...
    private fun putReserved(
        reservedNames: MutableSet<Identifier>,
        reservedNumbers: MutableSet<IntRange>,
