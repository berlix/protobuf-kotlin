...
class MapDecoder(
        ...
        currentEntry?.decodeElementIndex(descriptor)
            ...
            run {
                ...
                if (currentEntryIndex >= entries.size)
                    ...
                    currentEntry =
                        MessageDecoder(schemaGenerator, listOf(keyField, valueField), listOf(entries[currentEntryIndex]))
    ...
    override fun decodeInline(descriptor: SerialDescriptor): Decoder = error("ListDecoder does not support decodeInline")
