...
class SchemaGeneratorMapTest : SchemaGeneratorBaseTest() {
    ...
    fun `creates schema for class with map of scalars`() {
        ...
        verifyConversion(ClassWithMapOfScalars(mapOf("key" to 5, "key2" to 6)), """1: { 1: { "key" } 2: 5 } 1: { 1: { "key2" } 2: 6 }""")
    }
    ...
    fun `creates schema for class with nullable map`() {
        ...
        verifyConversion(ClassWithNullableMap(mapOf("key" to 5, "key2" to 6)), """1: { 1: { 1: { "key" } 2: 5 } 1: { 1: { "key2" } 2: 6 } }""")
    }
    ...
    fun `creates schema for class with nested maps`() {
        ...
        verifyConversion(
            ...
            """1: { 1: { 1: { "k1" } 2: 1 } 2: { 1: { "v1" } 2: 11 } } 1: { 1: { 1: { "k2" } 2: 2 } 2: { 1: { "v2" } 2: 12 } }"""
        )
    }
    ...
    fun `creates schema for class with map with custom entry property names`() {
        ...
        verifyConversion(ClassWithMapWithCustomEntryPropertyNames(mapOf(1 to 5, 2 to 6)), """1: { 1: 1 2: 5 } 1: { 1: 2 2: 6 }""")
    }
